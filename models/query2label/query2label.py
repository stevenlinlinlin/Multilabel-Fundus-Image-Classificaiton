...
from models.query2label.backbone import build_backbone
from models.query2label.transformer import build_transformer
...
def build_q2l(num_class):
    backbone = build_backbone(num_class)
