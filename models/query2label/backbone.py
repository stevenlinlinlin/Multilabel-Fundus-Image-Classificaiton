...
import models
from models.query2label.cls_cvt import build_CvT
from models.query2label.swin_transformer import build_swin_transformer

from models.query2label.utils.misc import clean_state_dict
...
def get_model_path(modelname):
    ...
    pretrained_dir = './models/query2label/cls_cvt' # model pretrained weights path
    PTDICT = {
        'CvT_w24': 'CvT-w24-384x384-IN-22k.pth',
        'CvT_21_384' : 'CvT-21-384x384-IN-22k.pth',
...
def build_backbone(num_class, args=None):
    ...
    if backbone_name in ['swin_B_224_22k', 'swin_B_384_22k', 'swin_L_224_22k', 'swin_L_384_22k']:
        ...
        backbone = build_swin_transformer(backbone_name, imgsize)
        
        pretrainedpath = get_model_path(backbone_name)
        ...
        del backbone.head
    elif backbone_name in ['CvT_w24', 'CvT_21_384']:
        backbone = build_CvT(backbone_name, num_class)
